...
240 Varsion_Name$ = "バージョン:0.1.2.2021.07.19"
...
2980 print #2,str$(count) + "," + buf_name$+"," + str$(born_year) + "," + str$(born_month) + "," + str$(born_day)+"," + Sun_crest$ + "," + Wave_spell$
2990 close #2
3000 else
3010 open "data/Parsonal.csv" for append as #1
3020 print #1,str$(count)+"," + buf_name$+"," + str$(born_year) + "," + str$(born_month) + "," + str$(born_day) + "," + Sun_crest$ + "," + Wave_spell$
3030 close #1
3040 endif
...
3320 count = count
3330 N = count
3340 open "data/Parsonal.csv" for input as #1
3350 'for j=1 to count-1
3360 for i=0 to ((N)*7) - 1
3370 input #1,buffer_list$(i)
3380 next i
3390 'NEXT j
3400 'wend
3410 close #1
3420 for j = 7 to ((N)*7) - 1
3430 list$(j-7) = buffer_list$(j)
3440 next j
3450 'erase buffer_list$
3460 cls
3470 print "マヤ暦　登録リスト" + chr$(13)
3480 print chr$(13)
3490 n=0
3500 while (N >=(n mod N)+1)
3510 color rgb(212,255,127)
3520 if (N=1) then
3530 print "No:";list$(7*(N-1)+0) + chr$(13)
3540 print "名前:";list$(7*(N-1)+1) + chr$(13)
3550 print "誕生日:";list$(7*(N-1)+2);"年";list$(7*(N-1)+3);"月";list$(7*(N-1)+4);"日"+chr$(13)
3560 print "太陽の紋章:";list$(7*(N-1)+5)+chr$(13)
3570 print "ウェーブスペース:";list$(7*(N-1)+6)+chr$(13)
3580 color rgb(255,255,255)
3590 print "エンターキー:トップ" + chr$(13)
3600 key$ = input$(1)
3610 if key$ = chr$(13) then goto Top_Screen:
3620 else
3630 cls
3640 print "マヤ暦 登録リスト"+chr$(13)
3650 print chr$(13)
3660 print "No:";list$(7*(n)+0)+chr$(13)
3670 print "名前:";list$(7*(n)+1)+chr$(13)
3680 print "誕生日:";list$(7*(n)+2);"年";list$(7*(n)+3);"月";list$(7*(n)+4);"日"+chr$(13)
3690 print "太陽の紋章:";list$(7*(n)+5)+chr$(13)
3700 print "ウェーブスペース:";list$(7*(n)+6)+chr$(13)
3710 color rgb(255,255,255)
3720 print "スペース:次へ、エンターキー:トップ"+chr$(13)
3730 key$ = input$(1)
3740 if key$ = chr$(13) then goto Top_Screen:
3750 if key$ = "" then n=n+1:(n=(n) mod N)
3760 endif
3770 wend
